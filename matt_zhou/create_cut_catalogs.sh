...
SCRIPT="/global/cfs/projectdirs/desi/users/zhouc/desi_lsb/forked_repos/LSS/matt_zhou/mkCat_mass_subsamp.py"
OUTPUT_DIR="/global/cfs/projectdirs/desi/users/zhouc/desi_lsb/data/cut_catalog_iron"
...
mkdir -p $OUTPUT_DIR/mass_cut/1_2
python $SCRIPT \
    --outdir $OUTPUT_DIR/mass_cut/1_2 \
...
mkdir -p $OUTPUT_DIR/mass_cut/2_3
python $SCRIPT \
    --outdir $OUTPUT_DIR/mass_cut/2_3 \
    --input_tracer BGS_BRIGHT \
    --zmin 0.2 \
    --zmax 0.3 \
    --ccut _masscut-${MIN_MASS}-${MAX_MASS}
...
mkdir -p $OUTPUT_DIR/mass_cut/3_4
python $SCRIPT \
    --outdir $OUTPUT_DIR/mass_cut/3_4 \
    --input_tracer BGS_BRIGHT \
    --zmin 0.3 \
    --zmax 0.4 \
